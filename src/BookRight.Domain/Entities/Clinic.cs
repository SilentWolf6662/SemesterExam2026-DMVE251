...
public class Clinic : AggregateRoot
{
    ...
    public List<WorkingHour> WorkingHours { get; private set; } = null!;
    public int Rooms { get; private set; }

    // PRIVAT constructor — tvinger brug af factory-metoden Create()
    private Clinic() { } // EF Core
    private Clinic(Address clinicAddress, List<WorkingHour> workingHours, int rooms)
    {
    ...
    public static Clinic Create(Address clinicAddress, List<WorkingHour> workingHours, int rooms)
    {
